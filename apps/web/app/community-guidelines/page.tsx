    ...
    <div className="min-h-screen bg-background px-5 pb-16 text-foreground sm:px-8 lg:px-10">
      ...
      <main className="relative z-10 mx-auto mt-8 max-w-3xl">
        <div className="rounded-lg border border-border bg-elevated/50 p-8 sm:p-12">
          ...
          <h1 className="pm-display text-2xl sm:text-3xl">Community Guidelines</h1>
          ...
          <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
            ...
            <h2 className="pm-display text-base text-foreground">1. Be Respectful</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">2. No Spam or Self-Promotion</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">3. Keep Content Appropriate</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">4. Respect Privacy</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">5. No Impersonation</h2>
            <p>
              Do not impersonate other individuals, organizations, or brands. Your profile should accurately represent you or your studio.
            </p>

            <h2 className="pm-display text-base text-foreground">6. Intellectual Property</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">7. Reporting Violations</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">8. Consequences</h2>
            <p>
            ...
            <h2 className="pm-display text-base text-foreground">9. Updates</h2>
            <p>
