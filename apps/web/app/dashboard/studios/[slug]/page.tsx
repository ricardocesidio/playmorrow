...
import {
  ...
  Gauge, ExternalLink, Gamepad2, PanelLeft, FileText, Workflow, LineChart, Radio, Library, Users, ShieldCheck, Settings
} from 'lucide-react';
          ...
          <div className="clip-corner sticky top-0 min-h-screen border-border/90 bg-[#050b0f]/88 p-3 shadow-[0_18px_70px_rgb(0_0_0_/_0.36)]">
            ...
            <nav className="mt-3 space-y-1">
              {[
                ...
                { href: '/dashboard/roadmap', icon: <Workflow className="size-4" />, label: 'Roadmap' },
                ...
                { href: '/dashboard/media', icon: <Library className="size-4" />, label: 'Media Library' },
