    ...
    <>
      ...
      <main className="relative min-h-screen bg-[#020609] px-5 pb-28 pt-4 sm:px-8 lg:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <button
            onClick={() => router.back()}
            className="mb-4 flex items-center gap-2 font-mono text-[0.6rem] uppercase tracking-widest text-muted-foreground transition hover:text-cyan"
          >
            ...
            <div className="mt-4">
              <Button variant="outline" asChild>
                <a href={listing.fileUrl} target="_blank" rel="noopener noreferrer">
                  <Download className="size-3" /> Download Sample
                </a>
              </Button>
            </div>
          )}
