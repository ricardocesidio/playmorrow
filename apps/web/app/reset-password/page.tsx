      ...
      <div className="w-full max-w-sm border border-border bg-elevated p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full border border-input bg-background px-3 py-2 font-mono text-sm focus:border-cyan focus:outline-none" autoComplete="new-password" />
          </div>
          <div>
            ...
            <input id="confirm" type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} className="w-full border border-input bg-background px-3 py-2 font-mono text-sm focus:border-cyan focus:outline-none" autoComplete="new-password" />
          </div>
