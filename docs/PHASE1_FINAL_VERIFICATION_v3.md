...
| Monitoramento | ✅ UptimeRobot: API health ativo. Frontend: pendente adicionar. |
| CSP + Railway URLs | ✅ 0 referências Railway em CSP/config. `next.config.ts` images limpo. |
